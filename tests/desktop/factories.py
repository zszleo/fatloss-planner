...
from fatloss.models.nutrition_plan import NutritionPlan
...
class TestDataFactory:
    ...
    @staticmethod
    def create_weight_records(user_id: int, count: int = 30, 
                            start_date: Optional[date] = None) -> list[WeightRecord]:
        """创建连续体重记录序列。
    ...
    @staticmethod
    def create_nutrition_plan(user_id: int, **kwargs) -> NutritionPlan:
        """创建营养计划测试数据。
